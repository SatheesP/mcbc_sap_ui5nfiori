		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "List Binding Products",
									"targetURL": "#masterclassui5listbindingproducts-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"masterclassui5listbindingproducts-display": {
								"semanticObject": "masterclassui5listbindingproducts",
								"action": "display",
								"description": "List Binding Products",
								"title": "List Binding Products",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=masterclass.ui5.listbindingproducts",
									"url": sap.ui.require.toUrl("masterclass/ui5/listbindingproducts")
								}
							}
						}
					}
