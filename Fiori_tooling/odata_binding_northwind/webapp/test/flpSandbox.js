		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "OData Northwind Read",
									"targetURL": "#masterclassui5odatabindingnorthwind-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"masterclassui5odatabindingnorthwind-display": {
								"semanticObject": "masterclassui5odatabindingnorthwind",
								"action": "display",
								"description": "OData Northwind Read",
								"title": "OData Northwind Read",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=masterclass.ui5.odata.bindingnorthwind",
									"url": sap.ui.require.toUrl("masterclass/ui5/odata/bindingnorthwind")
								}
							}
						}
					}
