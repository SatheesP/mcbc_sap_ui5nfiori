		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "OData Northwind Read Table",
									"targetURL": "#masterclassui5odatabindingnwtable-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"masterclassui5odatabindingnwtable-display": {
								"semanticObject": "masterclassui5odatabindingnwtable",
								"action": "display",
								"description": "OData Northwind Read Table",
								"title": "OData Northwind Read Table",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=masterclass.ui5.odata.bindingnwtable",
									"url": sap.ui.require.toUrl("masterclass/ui5/odata/bindingnwtable")
								}
							}
						}
					}
