		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "List Binding Tree",
									"targetURL": "#masterclassui5listbindingtree-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"masterclassui5listbindingtree-display": {
								"semanticObject": "masterclassui5listbindingtree",
								"action": "display",
								"description": "List Binding Tree",
								"title": "List Binding Tree",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=masterclass.ui5.listbindingtree",
									"url": sap.ui.require.toUrl("masterclass/ui5/listbindingtree")
								}
							}
						}
					}
