		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Context Binding Sports",
									"targetURL": "#contextbindingsports-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"contextbindingsports-display": {
								"semanticObject": "contextbindingsports",
								"action": "display",
								"description": "Context Binding Sports",
								"title": "Context Binding Sports",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=contextbindingsports",
									"url": sap.ui.require.toUrl("contextbindingsports")
								}
							}
						}
					}
